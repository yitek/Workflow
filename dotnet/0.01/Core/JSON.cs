...
namespace WFlow
{
    public static class JSON
    {
        ...
        public static bool SetPathValue(JToken target, string expr, JToken value)
        {
            ...
            target[texts[texts.Length - 1]] = value;
            return true;
        }
        ...
        static List<Func<JToken,  JToken>> ParseExprText(string text) {
            ...
            exprs.Add((input)=> input.SelectToken(propPath));
        ...
        static ConcurrentDictionary<string, Func<JToken, string[], JToken>> funcs = new ConcurrentDictionary<string, Func<JToken, string[], JToken>>();
        static ConcurrentDictionary<string, List<Func<JToken, JToken>>> JPathResolvers = new ConcurrentDictionary<string, List<Func<JToken, JToken>>>() ;
    }
}
